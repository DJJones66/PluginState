...
class PluginStateLifecycleManager(BaseLifecycleManager):
    """Lifecycle manager for PluginTemplate plugin using new architecture"""
    
    def __init__(self, plugins_base_dir: str = None):
        """Initialize the lifecycle manager"""
        # Plugin State Test Plugin - demonstrates state persistence functionality
        self.plugin_data = {
            "name": "PluginState",
            ...
            "is_local": False,
            "long_description": "A comprehensive test plugin for validating BrainDrive plugin state persistence functionality. Includes examples of state configuration, save/restore operations, and cross-page persistence.",
            "plugin_slug": "PluginState",
            # Update tracking fields (matching plugin model)
            "source_type": "local",
            "source_url": "file://PluginBuild/PluginState",
        ...
        self.module_data = [
            {
                ...
                "priority": 1,
                "props": {
                    "title": "Plugin State Test",
                    "description": "Test plugin state persistence functionality",
                    "config": {
                        "autoSave": True,
                        "showDebugInfo": True,
                ...
                "config_fields": {
                    "title": {
                        "type": "text",
                        "description": "Test component title",
                        "default": "Plugin State Test"
                    },
                    "auto_save": {
                        "type": "boolean",
                        "description": "Automatically save state on changes",
                        "default": True
                    },
                    "show_debug_info": {
                        "type": "boolean",
                ...
                "tags": ["state", "persistence", "test", "example"]
            }
        ]
    ...
    async def update_plugin(self, user_id: str, db: AsyncSession, new_version_manager: 'PluginStateLifecycleManager') -> Dict[str, Any]:
...
async def install_plugin(user_id: str, db: AsyncSession, plugins_base_dir: str = None) -> Dict[str, Any]:
    manager = PluginStateLifecycleManager(plugins_base_dir)
...
async def update_plugin(user_id: str, db: AsyncSession, new_version_manager: 'PluginStateLifecycleManager', plugins_base_dir: str = None) -> Dict[str, Any]:
    old_manager = PluginStateLifecycleManager(plugins_base_dir)
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        manager = PluginStateLifecycleManager()
