// Utility functions for BrainDrive Plugin State Example
 ...
 * Useful for auto-saving state changes
 */
...
/**
 * Deep clone an object - useful for state management
 */
 ...
 * Useful for state serialization/deserialization
 */
